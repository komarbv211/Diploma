...
const ProductFilter: React.FC<Props> = ({ onChange, isAdmin }) => {
  ...
  return (
    ...
    >
      {/* Кнопка‑хрестик */}
      {/* <button
        onClick={handleReset}  // або інша дія: сховати/закрити фільтр
        className="absolute top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none z-10 p-1"
        style={{ left: "399px" }}
      >
        {/* Можеш використати свій компонент іконки чи ToggleIconButton */}
        {/* ✕
      </button> */}
