import { AppstoreOutlined, DeleteOutlined, LogoutOutlined, UsergroupAddOutlined, ProductOutlined } from '@ant-design/icons';
...
const AdminSidebar = () => {
  ...
  return (
    <Menu mode="inline" defaultSelectedKeys={['1']} className='py-1' onSelect={({ key }) => navigate(key)}>
      ...
      <Menu.Item key="/admin/categories" icon={<AppstoreOutlined />}>Категорії</Menu.Item>
      ...
      <Menu.Item key="/admin/testing" icon={<ProductOutlined />}>Тестуємо</Menu.Item>
        <Menu.Item key="/admin/promotions" icon={<ProductOutlined />}>Акції</Menu.Item>
