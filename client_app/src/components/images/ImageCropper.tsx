...
const ImageCropper: React.FC<ImageCropperProps> = ({
    ...
    return (
        <div>
            ...
            <div className="mt-4">
                <button onClick={cropImage} className="px-4 py-2 bg-blue-500 text-white rounded-md">
                    {buttonText}
                </button>
                {onCancel && (
                    <button onClick={onCancel} className="ml-2 px-4 py-2 bg-gray-300 text-white rounded-md">
                        Скасувати
                    </button>
                )}
