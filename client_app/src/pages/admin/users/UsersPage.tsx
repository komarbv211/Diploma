...
//   // Нові стани: тип фільтрації по даті і одна дата
//   const [dateFilterType, setDateFilterType] = useState<"start" | "end">("start");
//   const [selectedDate, setSelectedDate] = useState<Dayjs | null>(null);

//   const { DatePicker: DatePickerAntd } = DatePicker; // не обов’язково, але можна так зробити
...
//     // startDate: dateFilterType === "start" ? selectedDate?.format("DD.MM.YYYY") : undefined,
//     // endDate: dateFilterType === "end" ? selectedDate?.format("DD.MM.YYYY") : undefined,
...
//             {/* Вибір поля для фільтрації по даті */}
//             <Select

//   //   value={dateFilterType}
//   //   onChange={(value) => {
//   //     setDateFilterType(value);
//   //     setSelectedDate(null); // скидаємо дату при зміні типу
//   //     setCurrentPage(1);
//   //   }}
//   //   style={{ width: 180 }}
//   // >
//   //   <Select.Option value="start">Дата створення</Select.Option>
//   //   <Select.Option value="end">Дата активності</Select.Option>
//   // </Select>

//   // <DatePicker
//   //   placeholder={dateFilterType === "start" ? "Виберіть дату початку" : "Виберіть дату кінця"}
//   //   value={selectedDate}
//   //   onChange={(date) => {
